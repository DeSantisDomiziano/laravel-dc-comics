...
<div class="container py-5 bg-dark-subtle rounded-4 my-4">
    ...
    <form action="{{route('admin.comics.update', $comic->id)}}" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" aria-describedby="nameHelper" value="{{ old('price', $comic->title) }}" required>
            <small id="nameHelper" class="text-muted">Change Title</small>
        </div>

        <div class="mb-3">
            <label for="thumb" class="form-label fs-4 fw-bold">Image</label>
            <input type="text" name="thumb" id="thumb" class="form-control @error('thumb') is-invalid @enderror" aria-describedby="thumbHelper" value="{{ old('price', $comic->thumb) }}" required>
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description" rows="3">{{old('price', $comic->description)}}
          </textarea>
        ...
        <div class="mb-3">
            ...
            <input type="date" name="sale_date" id="sale_date" class="form-control @error('sale_date') is-invalid @enderror" aria-describedby="sale_dateHelper" value="{{ old('price', $comic->sale_date) }}">
            <small id="sale_dateHelper" class="text-muted">Change Sale Date</small>
        </div>

        <div class="mb-3">
            <label for="type" class="form-label fs-4 fw-bold">Type</label>
            <input type="text" name="type" id="type" class="form-control @error('type') is-invalid @enderror" aria-describedby="typeHelper" value="{{ old('price', $comic->type) }}">
